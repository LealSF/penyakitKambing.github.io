<ul class="nav flex-column ml-3 mb-5" style="min-height : 100vh;">
    ...
    <li class="nav-item">
      <a class="nav-link text-white" href="dataPenyakit.php"><i class="fa-solid fa-skull-crossbones m-lg-2"></i>Data Penyakit <hr class="bg-secondaray"></a>
    </li>
    <li class="nav-item">
      <a class="nav-link text-white" href="dataGejala.php"><i class="fa-solid fa-temperature-full m-lg-2"></i>Data Gejala <hr class="bg-secondaray"></a>
    </li>
    <li class="nav-item">
